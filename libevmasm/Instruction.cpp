...
const std::map<std::string, Instruction> dev::solidity::c_instructions =
{
	...
	{ "INFER", Instruction::INFER },
	{ "INFERARRAY", Instruction::INFERARRAY},
	{ "NNFORWARD", Instruction::NNFORWARD},
	{ "SOFTMAX", Instruction::SOFTMAX},
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::INFER,		{ "INFER",			0, 2, 1, true, Tier::Ext} },
	{ Instruction::INFERARRAY,	{ "INFERARRAY",		0, 2, 1, true, Tier::Ext} },
	{ Instruction::NNFORWARD,	{ "NNFORWARD",		0, 3, 1, true, Tier::Ext} },
	{ Instruction::SOFTMAX,	    { "SOFTMAX",		0, 2, 1, true, Tier::Ext} },
